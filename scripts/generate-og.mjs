...
const STATIC_ROUTES = [
  ...
  { pathname: '/extension/privacy/', title: 'Extension privacy', subtitle: 'Nothing leaves your browser — no servers, no telemetry, no analytics.' },
  { pathname: '/mcp/', title: 'MCP server', subtitle: 'Connect AI agents to the Playbill — read-only, no API key.' },
  { pathname: '/har-analyzer/', title: 'HAR Analyzer', subtitle: 'Parse HAR files locally in your browser — no upload, no server, no tracking.' },
